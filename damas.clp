...
=>
	...
	(switch ?tamano
		...
		(case 8 then
			(modify ?tablero (fichas o 11 o 13 o 15 o 17 o 22 o 24 o 26 o 28 o 31 o 33 o 35 o 37 x 62 x 64 x 66 x 68 x 71 x 73 x 75 x 77 x 82 x 84 x 86 x 88))
			(assert (tamano 24))
		)
	)
	(if (= ?jugador 1) then
		...
		(if (> ?ficha 0) then
			...
			(assert (control 1))
                        ...
                        (if (and (= ?jugIni 2)(= ?turn 1)) then ;Vemos si es la maquina
                                (if (or (>= ?pos_nueva_ficha 11) (> ?pos_nueva_ficha 80)) then ;Miramos si la posición es de victoria, es decir, que la fila sea 1. Si lo es añadimos un punto
                                        (bind ?puntosMaquina (+ ?puntosMaquina 1))
                                        (retract ?pMaq)
                                        (assert (puntuacionMaquina ?puntosMaquina))
                                        (bind ?f (replace$ $?f (* (nth$ ?ficha ?fichas_que_comen)2) (* (nth$ ?ficha ?fichas_que_comen)2) 0))
